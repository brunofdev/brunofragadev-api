...
public class ServicoDeEmail {
    ...
    // =========================================================================
    public void enviarEmailDeRecuperacaoDeSenha(String emailDestino, String nomeDestino, String codigoVerificacao) {
        String assunto = "Recuperação de Senha - Bruno Dev";
        String conteudoHtml = String.format("""
                <html>
                <body style="font-family: Arial, sans-serif; color: #333;">
                    <h2>Olá %s,</h2>
        ...
        enviarEmailPelaApi(emailDestino, nomeDestino, assunto, conteudoHtml);
        System.out.println("✅ E-mail de recuperação de senha enviado para: " + emailDestino);
    }

    // =========================================================================
    // 6. LEMBRETE DE NOME DE USUÁRIO (Apenas o UserName)
    // =========================================================================
    public void enviarEmailLembreteDeUsuario(String emailDestino, String nomeDestino, String userName) {
        String assunto = "Seu Nome de Usuário - Bruno Dev";
        String conteudoHtml = String.format("""
                <html>
                <body style="font-family: Arial, sans-serif; color: #333;">
                    <h2>Olá %s,</h2>
                ...
                """, nomeDestino, userName);

        enviarEmailPelaApi(emailDestino, nomeDestino, assunto, conteudoHtml);
        System.out.println("✅ E-mail de lembrete de usuário enviado para: " + emailDestino);
    }
    // =========================================================================
    // 7. CONFIRMAÇÃO DE ALTERAÇÃO DE SENHA (Aviso de Segurança)
    // =========================================================================
    public void enviarEmailSenhaAlteradaComSucesso(String emailDestino, String nomeDestino) {
        String assunto = "Alerta de Segurança: Sua senha foi alterada";

        // Pega a data e hora atual do sistema formatada (Ex: 21/02/2026 às 22:09:30)
        java.time.format.DateTimeFormatter formatador = java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy 'às' HH:mm:ss");
        String dataHoraAtual = java.time.LocalDateTime.now().format(formatador);
        ...
        String conteudoHtml = String.format("""
                ...
                """, nomeDestino, dataHoraAtual);

        enviarEmailPelaApi(emailDestino, nomeDestino, assunto, conteudoHtml);
        System.out.println("✅ E-mail de segurança (senha alterada) enviado para: " + emailDestino);
    }
}